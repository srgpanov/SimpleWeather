...
object RetrofitClient {
    ...
    fun createWeatherService(): WeatherService {
        return createRetrofit(baseUrlWeather, getHttpClient(true)).create(WeatherService::class.java)
    }
    fun createPlacesService(): PlacesService {
        return createRetrofit(baseUrlPlaces, getHttpClient(false)).create(PlacesService::class.java)
    }
}